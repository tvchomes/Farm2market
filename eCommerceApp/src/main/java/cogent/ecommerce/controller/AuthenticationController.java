 ...
 * 
 * import cogent.ecommerce.config.CustomUserDetailsService; import
 * cogent.ecommerce.config.JwtUtil;
 * 
 * import cogent.ecommerce.config.*;
 * 
 * 
 ...
 * AuthenticationRequest authenticationRequest) throws Exception { try {
 * authenticationManager.authenticate(new
 * UsernamePasswordAuthenticationToken(authenticationRequest.getUsername(),
 * authenticationRequest.getPassword())); } catch (DisabledException e) { throw
 * new Exception("USER_DISABLED", e); } catch (BadCredentialsException e) {
 * throw new Exception("INVALID_CREDENTIALS", e); } final UserDetails
